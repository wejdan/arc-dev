...
const sections=[
 {title:'Vision',titleColor:"#0B72B9",text:
...
],textColor:"#868686",bgColor:"#ffffff",icon:vision,filiped:true,iconPostion:"center"},



{title:'Technology',titleColor:"#0B72B9",text:
...
],textColor:"#868686",bgColor:"#ffffff",animation:technologyAnimation,animationName:"technology",iconPostion:"center"},


{title:'Consultation',titleColor:"#000000",text:['Our process begins the moment you realize you need a piece of technology for your business. Whether you already have an idea for where to start and what to do, or if you just know you want to step things up, our initial consultation will help you examine your business holistically to find the best solutions',
...
],textColor:"#ffffff",bgColor:"#b3b3b3",icon:consultation,iconPostion:"flex-end"},

{title:'Mockup',titleColor:"#000000",
text:[
...
],textColor:"#ffffff",bgColor:"#ff7373",icon:mockup,iconPostion:"flex-end"},

{title:'Review',titleColor:"#000000",
text:[
...
],textColor:"#ffffff",bgColor:"#39b54a",icon:review,iconPostion:"flex-end"},

{title:'Design',titleColor:"#000000",
text:[
...
],textColor:"#ffffff",bgColor:"#a67c52",icon:design,iconPostion:"flex-end"},
...
'This time we’ll be going over the finalized designs in another fully interactive demonstration. Again this gives you an opportunity to tweak things and make sure we get everything right the first time.',
],textColor:"#ffffff",bgColor:"#fbb03b",icon:build,iconPostion:"flex-end"},


{title:'Launch',titleColor:"#000000",
text:[
...
],textColor:"#ffffff",bgColor:"#c1272d",icon:launch,iconPostion:"flex-end",justify:"flex-start"},


{title:'Maintain',titleColor:"#000000",
text:[
...
],textColor:"#ffffff",bgColor:"#8e45ce",icon:maintain,iconPostion:"flex-end"},


{title:'Iterate',titleColor:"#000000",
text:[
...
],textColor:"#ffffff",bgColor:"#29abe2",icon:iterate,iconPostion:"flex-end"},
]
var tech;
const Title=styled(Typography)(({theme})=>({

   ...theme.typography.revloutionTitle,
   textAlign:"center",
   [theme.breakpoints.down('md')]: {  paddingLeft:"1rem",paddingRight:"1rem",marginTop:"1.5rem",textAlign:"center"},
   [theme.breakpoints.up('md')]: {  paddingLeft:"4rem",paddingRight:"3rem",marginTop:"2rem",textAlign:"left"},
...
function Revolution() {
    ...
    console.log(theme.typography.revloutionTitle)

  React.useEffect(() => {
        tech=lottie.loadAnimation({
          container: document.querySelector("#technology"),
...
<Grid item xs={12} >
    <Title >The Revolution</Title>
           ...
           {sections.map((section)=>{
               return <Section {...section} animation={section.animation?tech:undefined} />
           })} 
